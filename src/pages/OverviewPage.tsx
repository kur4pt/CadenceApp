...
export function OverviewPage() {
    return (
        <>
            <PageHeading title="Good afternoon." description='Your academic day,  deadlines, and all important schedule will converge here.'/>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-3">
                {[
                    ...
                    { icon: CalendarCheck2, title: 'Verify schedule', copy: 'Nothing reaches the canonical calendar until you confirm the extracted details.' },
                    { icon: Sparkles,       title: 'Urgency engine',  copy: 'Exam and assignments priority will combine deterministic dates with syllabus context.' },
