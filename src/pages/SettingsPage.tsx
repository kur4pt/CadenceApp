            ...
            <div className="grid max-w-3xl gap-4">
                ...
                <section className="surface-card p-5">
                    ...
                    <div className="flex gap-2">
                        <button onClick={() => setMode('light')} className={`focus-ring flex items-center gap-2 rounded-xl border px-3 py-2 text-sm ${mode=== 'light' ? 'border-[rgb(var(-foreground))]' : 'border-[rgb(var(--border))]'}`}> Light</button>
                        <button onClick={() => setMode('dark')} className={`focus-ring flex items-center gap`}></button>
                    </div>
                </section>
            </div>
        </>
